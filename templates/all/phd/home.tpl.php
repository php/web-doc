...
<ul id="releases">
  <li>
    ...
    <ul class="fixes">
      <li><?php bufgix(44906); ?> (Missing space after modifier in properties list). (Hannes)</li>
      <li><?php bufgix(44881); ?> (Class constants with $). (Hannes)</li>
      <li><?php bufgix(44786); ?> (Remove irrelevant version information). (Hannes)</li>
      <li><?php bufgix(44785); ?> (Separating &lt;title&gt; from &lt;note&gt;). (Hannes)</li>
      <li><?php bufgix(44776); ?> (Request for change in titles). (Hannes)</li>
      <li><?php bufgix(44750); ?> (Request for generic phd logger). (Hannes)</li>
      <li><?php bufgix(44690); ?> (Please restore manual main page). (Hannes)</li>
