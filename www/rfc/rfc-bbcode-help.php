...
<table class="forumline" width="75%" cellspacing="1" cellpadding="3" border="0" align="left">
 <tr>
...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
 <tr>
  <td class="row1" align="left" valign="top"><span class="postbody"><a name="9"></a><b>Adding an image to a post</b></span><br /><span class="postbody">phpBB BBCode incorporates a tag for including images in your posts. Two very important things to remember when using this tag are: many users do not appreciate lots of images being shown in posts and second, the image you display must already be available on the Internet (it cannot exist only on your computer, for example, unless you run a webserver!). There is currently no way of storing images locally with phpBB (all these issues are expected to be addressed in the next release of phpBB). To display an image, you must surround the URL pointing to the image with <b>[img][/img]</b> tags. For example:<br /><br /><b>[img]</b><?php echo get_resource_url('images/php.gif');?><b>[/img]</b><br /><br />As noted in the URL section above you can wrap an image in a <b>[url][/url]</b> tag if you wish, eg.<br /><br /><b>[url=<?php echo get_resource_url();?>][img]</b><?php echo get_resource_url('images/php.gif');?><b>[/img][/url]</b><br /><br />would generate:<br /><br /><a href="http://www.phpbb.com/" target="_blank"><img src="<?php echo get_resource_url('images/php.gif');?>" border="0" alt="" /></a><br /><br /><a class="postlink" href="#Top">Back to top</a></span></td>
 </tr>
 <tr>
...
// -->
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
     ...
     <p style="color: #444444; text-align: center; padding: 0; margin: 0; font-size: 10px; padding-top: 2px; ">Powered by <a href="http://www.phpbb.com" class="copyright">phpBB</a> &copy; 2001, 2003 <a href="http://www.phpbb.com/about.php" class="copyright">phpBB Group</a></td>
    </tr>
   </table>
  </td>
 </tr>
