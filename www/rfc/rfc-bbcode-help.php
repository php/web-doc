...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
 <tr>
  <td class="row1" align="left" valign="top"><span class="postbody"><a name="9"></a><b>Adding an image to a post</b></span><br /><span class="postbody">phpBB BBCode incorporates a tag for including images in your posts. Two very important things to remember when using this tag are: many users do not appreciate lots of images being shown in posts and second, the image you display must already be available on the Internet (it cannot exist only on your computer, for example, unless you run a webserver!). There is currently no way of storing images locally with phpBB (all these issues are expected to be addressed in the next release of phpBB). To display an image, you must surround the URL pointing to the image with <b>[img][/img]</b> tags. For example:<br /><br /><b>[img]</b>https://doc.php.net/images/php.gif<b>[/img]</b><br /><br />As noted in the URL section above you can wrap an image in a <b>[url][/url]</b> tag if you wish, eg.<br /><br /><b>[url=https://doc.php.net/][img]</b>https://doc.php.net/images/php.gif<b>[/img][/url]</b><br /><br />would generate:<br /><br /><a href="https://doc.php.net/" target="_blank"><img src="https://doc.php.net/images/php.gif" border="0" alt="" /></a><br /><br /><a class="postlink" href="#Top">Back to top</a></span></td>
 </tr>
 <tr>
