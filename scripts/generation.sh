...
/usr/bin/php4 -q ./rev.php gtk pt_BR cs fr de it es ja
echo "...terminé."
...
/usr/bin/php4 -q ./gen_picture_info.php gtk pt_BR zh hk tw cs nl fi fr de el he hu it kr pl ro ru sk sl es sv tr ja
echo "... terminé"
